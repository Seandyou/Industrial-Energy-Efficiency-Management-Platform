...
var Scroll = /** @class */ (function () {
    function Scroll(parent) {
        ...
        this.onMouseMove = function (e) {
            ...
            if (_this.isDownV) {
                ...
                if (_this.pageMode && _this.canMouseMove(y)) {
                    return;
                }
            ...
            if (_this.isDownH || _this.isDownV) {
                ...
                _this.parent.canvasTemplate.init();
    ...
    Scroll.prototype.canMouseMove = function (y) {
        var rect = this.parent.parent.getRect();
    ...
    Scroll.prototype.changeMode = function () {
        this.pageMode = true;
