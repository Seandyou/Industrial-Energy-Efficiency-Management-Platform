...
var Meta2d = /** @class */ (function () {
    ...
    Meta2d.prototype.setOptions = function (opts) {
        ...
        if (opts.rule !== undefined || opts.ruleColor !== undefined || opts.ruleOptions !== undefined) {
            ...
            if (opts.ruleOptions) {
                if ((_a = this.store.options) === null || _a === void 0 ? void 0 : _a.ruleOptions) {
        ...
        pens.forEach(function (pen) {
            ...
            if (pen.calculative.pause) {
                ...
                if (params !== undefined && pen.animations) {
                    ...
                    if (index === -1 && ((_b = pen.animations) === null || _b === void 0 ? void 0 : _b.length)) {
                        //默认执行第0个动画
                        index = 0;
                    }
                }
    ...
    Meta2d.prototype.initGlobalTriggers = function () {
        ...
        (_a = this.store.data.triggers) === null || _a === void 0 ? void 0 : _a.forEach(function (trigger) {
            trigger.conditions.forEach(function (condition) {
                if (condition.source) {
                    if (!_this.store.globalTriggers[condition.source]) {
                        _this.store.globalTriggers[condition.source] = [];
                    }
                    if (!_this.store.globalTriggers[condition.source].includes(trigger)) {
                        _this.store.globalTriggers[condition.source].push(trigger);
                    }
                }
            });
        });
    ...
    Meta2d.prototype.specificLayerMove = function (pen, type) {
        ...
        if (pen.image && pen.name !== 'gif') {
            ...
            // );
            var layer = CanvasLayer.CanvasImageBottom;
            if (type === 'top') {
            ...
            ((_a = pen.calculative.singleton) === null || _a === void 0 ? void 0 : _a.div) &&
